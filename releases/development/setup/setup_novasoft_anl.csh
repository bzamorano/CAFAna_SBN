...
# 10-Dec-12 J. Paley adapted for ANL
...
if ( ! $?NOVASOFT_SETUP ) then
    ...
    set SETUP_LOCATION=/n2data1/nova/software/novasoft-svn/setup
	...
	set result=`${SETUP_LOCATION}/setup_novasoft_setup_anl.sh -c $argv`
