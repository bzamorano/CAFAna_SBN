...
if [ "$#" -ne 3 ]; then
    ...
    echo " For example: `basename ${0}` sJJ:eII <debug | prof> $HOME/nova/"
    echo " the lastest version of the novasoft bundle, with qualifiers, can be found at http://scisoft.fnal.gov/scisoft/bundles/novasoft/"
    exit
fi
