...
set_srt () {
    ...
    print_var FW_DATA         "/n2data3/nova/data:/n2data3/nova/aux:/n2data3/nova/flux"   $shell_type 
    print_var NOVA_DATA       "/n2data3/nova/data"                                             $shell_type
...
set_devdb () {
    ...
    print_var NOVADBWSURL     "http://dbdata0.fnal.gov:8081/NOvACon/app/"              $shell_type
    print_var NOVADBNAME      "nova_prod"   					       $shell_type
    print_var NOVADBUSER      "nova_reader"                                            $shell_type
    print_var NOVADBPWDFILE   "/n2data3/nova/db/nova_reader_pwd"                       $shell_type
    print_var NOVADBGRIDPWDFILE "/n2data3/nova/db/nova_grid_pwd"                       $shell_type
    print_var NOVADBWSPWDFILE "/n2data3/nova/db/nova_devdbws_pwd"                      $shell_type
...
set_artworkbook () {
    ...
    print_var ART_WORKBOOK_WORKING_BASE "/n2data3/nova/app/users"                              $shell_type
    print_var ART_WORKBOOK_OUTPUT_BASE  "/n2data3/nova/app/users"                              $shell_type
