...
main () {
	...
	source $SRT_PUBLIC_CONTEXT/setup/setup_novagrid.sh -r ${release} -b ${build}  ${shell_type}
    ...
    echo "PWD: $PWD"
    echo
    echo -e "              \033[1;34m\033[4mWELCOME TO NOvASOFT\033[0m     "
    echo -e "\e[00;33m  ART:\e[0m $ART_VERSION           \e[00;33mROOT:\e[0m $ROOT_VERSION "
    echo
    echo -e "\e[00;32mHelp is nearby: #art, #cafana, and #nova_offline \e[0m"
    echo
    run_datagram
    nuke_tmp
    setup_nova_bashcompletion
